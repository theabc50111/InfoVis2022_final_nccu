function heatmap_rent(datapath,station_name) {
    ...
    .text(`The trip infomation when ${station_name} is the starting point. `);
  ...
  function heatmap_rent_click(e) {
      ...
      chart = heatmap_return(`./dataset/trip_time/rent_sno_${e.target.options.sno}.csv`,station_name);
      }   
